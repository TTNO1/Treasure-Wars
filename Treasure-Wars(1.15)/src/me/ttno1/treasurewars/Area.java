...
public class Area implements ConfigurationSerializable{
	...
	Area(HashMap<String, Object> deserializeMap){
		
		minCoord = Vector.deserialize((HashMap<String, Object>) deserializeMap.get("minCoord"));
		maxCoord = Vector.deserialize((HashMap<String, Object>) deserializeMap.get("maxCoord"));
		center = Vector.deserialize((Map<String, Object>) deserializeMap.get("center"));
		worldName = (String) deserializeMap.get("world");
	...
	public HashMap<String, Object> serialize() {
		...
		serializeMap.put("center", center.serialize());
		return serializeMap;
