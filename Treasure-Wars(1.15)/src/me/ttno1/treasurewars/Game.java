...
public class Game {
	...
	public String newMerchant(String name, Location location) {

		if(getMerchant(name) != null) {
			return ChatColor.RED + "A Merchant with that name already exists.";
		}
		
		merchants.add(new Merchant(new LazyLocation(location), name));
	...
	public String newCaptain(String name, Location location) {

		if(getCaptain(name) != null) {
			return ChatColor.RED + "A Captain with that name already exists.";
		}
		
		captains.add(new Captain(new LazyLocation(location), name));
